...
'Berra, Yogi', 'Berry, Halle', 'Berry, Wendell', 'Bethea, Erin', 'Bevan, Aneurin', 'Bevel, Ken', 'Biden, Joseph', 'Bierce, Ambrose', 'Biko, Steve', 'Billings, Josh', 'Biondo, Frank', 'Birrell, Augustine', 'Black, Elk', 'Blair, Robert', 'Blair, Tony', 'Blake, William'];
...
const birth = inventors.sort(function(firstPerson, secondPerson) {
...
console.table(birth);
// ES6
// const birth = inventors.sort((firstPerson, secondPerson) => firstPerson.year > secondPerson.year ? 1 : -1);



// Array.prototype.reduce()
// 4. How many years did all the inventors live?
const yearsLived = inventors.reduce(function(accumulator, inventor){
...
const yearsLived2 = inventors.sort(function(firstPerson, secondPerson) {
